...
export function IndexTable() {
	...
	const rowMarkup = orders.map(({ id, order, date, customer, total, paymentStatus, fulfillmentStatus }, index) => (
		<PolarisIndexTable.Row id={id} key={id} selected={selectedResources.includes(id)} position={index}>
			<PolarisIndexTable.Cell>
				<Text variant="bodyMd" fontWeight="bold" as="span">
					{order}
				</Text>
			</PolarisIndexTable.Cell>
			<PolarisIndexTable.Cell>{date}</PolarisIndexTable.Cell>
			<PolarisIndexTable.Cell>{customer}</PolarisIndexTable.Cell>
			<PolarisIndexTable.Cell>{total}</PolarisIndexTable.Cell>
			<PolarisIndexTable.Cell>{paymentStatus}</PolarisIndexTable.Cell>
			<PolarisIndexTable.Cell>{fulfillmentStatus}</PolarisIndexTable.Cell>
